...
import { View, Text, TextInput, Image, TouchableOpacity, FlatList, ScrollView, Alert } from 'react-native';
  ...
  return (
    <ScrollView>
      <View style={tw`flex-1 p-4 bg-white mb-10`}>
        ...
        {/* Header with Back Button & Logout Button */}
        <View style={tw`flex-row justify-between items-center mb-6`}>
          <BackArrowButton />
          <TouchableOpacity
           style={tw`bg-violet-500 py-2 px-4 rounded-xl flex-row items-center`}
